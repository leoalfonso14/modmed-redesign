...
import { DollarSign, ShieldAlert, BarChart3, TrendingUp, HeartHandshake, CheckCircle } from "lucide-react";
...
const RCM_FEATURES = [
  {
    ...
    description: "Our dedicated billing teams and certified coders handle your collections, claims, and denials, so you can spend more time with patients.",
    icon: HeartHandshake,
  ...
  },
  {
    ...
    description: "Our PM integration identifies errors before you submit, leading to 98% first-pass claim acceptance and accelerated cash flow.",
    icon: CheckCircle,
  ...
  },
  {
    ...
    description: "Real-time visibility into your revenue cycle. Track collections, A/R aging, and payer performance down to the individual encounter.",
    icon: BarChart3,
    color: "text-blue-500",
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <SolutionHero 
        ...
        icon={DollarSign}
        primaryCTA="Get a Billing Audit"
      />
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-24">
             <div className="lg:w-1/2">
                <Badge className="bg-emerald-500/10 text-emerald-400 border-emerald-500/20 mb-8 font-black tracking-widest italic uppercase">Revenue Recovery</Badge>
                <h2 className="text-5xl font-black mb-8 tracking-tighter leading-tight italic">
                   Don't let $125 billion <br /> 
                   <span className="text-emerald-500 underline decoration-white/20 underline-offset-8">stay on the table.</span>
                </h2>
                <p className="text-slate-400 text-lg font-medium leading-relaxed mb-12">
                   Medical billing is becoming more complex, but it shouldn't be your burden. Our RCM specialists become an extension of your team.
                </p>
                <div className="space-y-6">
                   {[
                     ...
                     <div key={item} className="flex gap-4 items-start">
                        ...
                        <span className="text-slate-300 font-bold uppercase text-xs tracking-widest leading-loose">{item}</span>
                     </div>
                   ))}
                </div>
             </div>
             ...
             >
                <div className="space-y-8">
                   <div className="flex items-center justify-between border-b border-slate-100 pb-6">
                      <div className="text-slate-400 text-[10px] font-black uppercase tracking-widest">Billing Accuracy</div>
                      <div className="text-emerald-500 font-bold">99.9%</div>
                   </div>
                   <div className="flex items-center justify-between border-b border-slate-100 pb-6">
                      <div className="text-slate-400 text-[10px] font-black uppercase tracking-widest">Cashflow Improvement</div>
