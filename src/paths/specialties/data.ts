...
const EHR_CARD = (desc: string, cta = 'Explore EHR features'): SpecialtyFeatureCard => ({
  ...
  color: 'text-brand-purple-light', bg: 'bg-brand-purple/15', border: 'border-brand-purple/20',
});
const PM_CARD = (desc: string, cta = 'Improve operations'): SpecialtyFeatureCard => ({
  ...
  color: 'text-blue-400', bg: 'bg-blue-500/15', border: 'border-blue-500/20',
});
...
const SCRIBE_CARD: SpecialtyFeatureCard = {
  ...
  cta: 'Meet Scribe 2.0',
  color: 'text-purple-300', bg: 'bg-purple-500/15', border: 'border-purple-500/20',
};
const MIPS_CARD: SpecialtyFeatureCard = {
  ...
  cta: 'Read up on MIPS',
  color: 'text-teal-400', bg: 'bg-teal-500/15', border: 'border-teal-500/20',
};
...
export const SPECIALTY_DATA: SpecialtyData[] = [
  ...
  // ── GASTROENTEROLOGY ──────────────────────────
  {
    ...
    features: [
      ...
      PATIENT_CARD,
      { title: 'gScribe™', href: '/solutions/ai/scribe', desc: 'AI-powered ambient listening built specifically for GI — converts natural conversation into structured HPIs, ICD-10 codes, and care plans.', cta: 'Meet gScribe™', color: 'text-purple-300', bg: 'bg-purple-500/15', border: 'border-purple-500/20' },
      RCM_CARD(),
      ANALYTICS_CARD,
      PAYMENT_CARD,
      SCRIBE_CARD,
