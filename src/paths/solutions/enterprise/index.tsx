...
const ENTERPRISE_FEATURES = [
  {
    ...
    description:
      "Manage dozens or hundreds of medical locations with centralized control and unified clinical data. Simplify complex operations with ease.",
    icon: Globe,
    color: "text-blue-500",
    href: "/contact",
  },
  {
    ...
    description:
      "Enterprise-grade security, logging, and compliance for the most demanding healthcare organizations. Built on a foundation of trust.",
    icon: ShieldCheck,
  ...
  },
  {
    ...
    description:
      "Our platform is built to handle millions of records and thousands of concurrent users without breaking a sweat. Scale without limits.",
    icon: Zap,
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Badge className="bg-white/10 text-white border-white/20 mb-8 font-black tracking-widest italic uppercase">
                Enterprise Excellence
              </Badge>
              <h2 className="text-5xl font-black mb-8 tracking-tighter leading-tight italic">
                The architecture of <br />
                <span className="text-brand-purple-light underline decoration-white/10">
                  at-scale healthcare.
                </span>
              </h2>
              <p className="text-slate-500 text-lg font-medium leading-relaxed mb-12 italic">
                We partner with major healthcare organizations to deliver
                streamlined clinical workflows and predictive operational
                insights across every location.
              </p>

              <div className="flex flex-wrap gap-8">
                <div className="flex flex-col gap-2">
                  <div className="text-3xl font-black text-brand-purple-light">
                    35K+
                  </div>
                  <div className="text-[10px] font-black uppercase text-slate-400 tracking-widest leading-tight">
                    Providers Trust Us
                  </div>
                </div>
                <div className="flex flex-col gap-2">
              ...
              <div className="w-full aspect-square bg-white/5 rounded-[64px] border border-white/5 p-12 relative flex items-center justify-center overflow-hidden backdrop-blur-3xl shadow-2xl">
                ...
                <div className="absolute top-12 left-12 p-6 bg-white rounded-3xl border border-slate-100 shadow-2xl flex items-center gap-4 animate-[fadeInUp_1s_ease-out]">
                  ...
                  <div>
                    ...
                    <div className="text-xl font-black text-slate-950 italic">
                      142 Locations
                    </div>
                  </div>
                </div>
      ...
      <Section>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h3 className="text-4xl font-black text-slate-950 mb-12 tracking-tighter leading-tight italic">
            "Building for a large specialty practice is hard. ModMed made it
            seem easy. Their platform scale and clinical depth are unmatched."
          </h3>
          <div className="text-brand-purple font-black uppercase text-xs tracking-widest mb-2 italic">
            Gheorghe Pusta
          </div>
